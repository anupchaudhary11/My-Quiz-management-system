...
<style>
    ...
    @media screen and (max-width: 450px) {
        ...
        p {
            color:rgb(27, 162, 211) !important;
        }
...
<body style="margin: 0 !important;font-weight: bolder !important;font-family:'Roboto', sans-serif;height:auto;color:#fff">
    <div id="main" style="background-color:rgb(27, 162, 211);height: auto;color:#fff !important">
    ...
    <section style="margin-left: 3rem;height:3rem;display:grid;padding-top: 8px;padding-bottom: 3px; font-size: 1.5rem;font-family: 'Libre Baskerville', serif;">Quiz Management System</section>
        ...
        <center><section style="width:90vw;margin:0vw;margin-top:4vw;font-size:2vw;">Welcome to Quiz Management System&nbsp;<?php echo $dbname ?></section></center>
           ...
           <center>
            ...
            <form style="margin: 5vw;width: 30vw" method="post">
                    <center>
                        ...
                        <input type="text" name="op4" placeholder="option3" required><br><br>
